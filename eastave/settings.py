"""
Django settings for eastave project.
...
SECRET_KEY = 'g9+18+5*n%c)1$^jrj(3n#6_0dj468&$rnuc#o2&s#y-&xq3r1'
...
ROOT_URLCONF = 'eastave.urls'


# FROM MEZZANINE TEMPLATE_DIRS
...
WSGI_APPLICATION = 'eastave.wsgi.application'
